# Django settings for faithinhumanity project.
...
DATABASES = {
    'default': {
        ...
        'NAME':  'faithinhumanity',                      # Or path to database file if using sqlite3.
        'USER': 'faithinhumanity_user',                      # Not used with sqlite3.
        'PASSWORD': '8hVCDvuHNtQ5jud2U3PojN1QRMDnvA',                  # Not used with sqlite3.
...
SECRET_KEY = 'R#adBl~SW,$D>0|7WipYb)wpcg#:0OT?krf6v!afY4,>/4?"!{'
...
ROOT_URLCONF = 'faithinhumanity.urls'

WSGI_APPLICATION = 'faithinhumanity.wsgi.application'
